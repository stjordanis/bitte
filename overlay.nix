...
in final: prev:
{
  ...
  grafana = nixpkgs-unstable.legacyPackages.${final.system}.callPackage
    ./pkgs/grafana.nix { };
  grafana-loki = nixpkgs-unstable.legacyPackages.${final.system}.callPackage
    ./pkgs/grafana-loki.nix { };
